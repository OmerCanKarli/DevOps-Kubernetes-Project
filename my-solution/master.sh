...
su - ubuntu -c 'helm repo add --username OmerCanKarli --password <Github Token> phonebook-app https://raw.githubusercontent.com/OmerCanKarli/Phonebook-Helm-Chart-Repo/main'
su - ubuntu -c 'helm install phonebook-app-release phonebook-app/phonebook-app'